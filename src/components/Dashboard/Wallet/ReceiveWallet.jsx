...
const ReceiveWallet = () => {
  return (
      <div className="fixed flex justify-center items-center top-0 left-0 w-full h-full bg-[rgba(0,0,0,.30)]  z-30">
          <div className="w-[30rem] h-[30rem] bg-white shadow-lg shadow-slate-500 flex justify-center items-center">
              <XIcon className="h-6 w-6 absoluite" aria-hidden="true" />

              <img src={qrcode} alt="Stack QRCode" className='w-[8rem] h-[8rem] ' />
