...
const Sidebar = ({ openModal, openSignUpModal }) => {
  ...
  try {
    var fixed = document.querySelector(".disableScroll");
  ...
  return (
    <>
      <div className="flex">
        ...
        >
          <div className="bg-zinc-50 bg-opacity-10 fixed top-0 left-0 w-[15%] h-[100%] overflow-x-hidden lg:hidden z-20 md:hidden disableScroll"></div>
        </Transition>
        <Transition
          as={Fragment}
          enter="transition ease-in-out duration-300 transform"
        ...
        >
          <Popover.Panel
            focus
            className="fixed top-0 right-0 w-[85%] h-screen transition overflow-x-hidden lg:hidden z-20 md:hidden"
          >
                    ...
                    {!loginState && (
                      <>
                        <div className="mt-2 py-5 flex justify-center items-center gap-10">
                          <div
                            className="text-black text-sm font-semibold px-4"
